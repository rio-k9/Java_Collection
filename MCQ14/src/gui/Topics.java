	...
	public Topics() throws ClassNotFoundException, SQLException {
		...
		deleteQuestionButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int deleteTopicAttempt = JOptionPane.showOptionDialog(null,"Are you sure you wish to delete this topic?","Delete Warning",JOptionPane.DEFAULT_OPTION,JOptionPane.WARNING_MESSAGE,null,deleteQuestionButton,deleteQuestionButton[1]);
