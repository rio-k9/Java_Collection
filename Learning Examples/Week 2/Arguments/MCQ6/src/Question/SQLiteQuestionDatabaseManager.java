...
public class SQLiteQuestionDatabaseManager {
	...
	public CachedRowSetImpl getQuestions(int TopicID) throws ClassNotFoundException, SQLException {
	...
	private CachedRowSetImpl _getTopicID(String topicName) throws SQLException, ClassNotFoundException {
	...
	private CachedRowSetImpl _getQuestions(int TopicID) throws SQLException {
		if (connection == null) {
			getConnection();
		}
